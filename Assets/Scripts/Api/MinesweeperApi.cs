...
namespace Minesweeper.API {
    ...
    public class MinesweeperApi {
        public async Task<ServerTestCallbackHandler> ServerTestAsync() {
        ...
        public async Task<StartGameCallbackHandler> StartGameAsync(LevelConfig levelConfig) {
            // Create the URI for the GET request
        ...
        public async Task<SelectGridPositionCallbackHandler> SelectGridPositionAsync(string gameId, int positionX,
            int positionY) {
            // Create the URI for the GET request
